...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/code/DEMO/css/scroll.css" />
		<script type="text/javascript" src="/code/DEMO/javascript/jquery-1.7.2.min.js"></script>
		<script type="text/javascript" src="/code/DEMO/javascript/scroll.js"></script>
	</head>
	<body>
		<div id="scroll">
...
<img src="/code/DEMO/images/div.jpg" />
